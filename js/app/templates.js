...
Ember.TEMPLATES['administration/strategy'] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
...
function program3(depth0,data) {
  ...
  hashContexts = {};
  options = {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data};
  data.buffer.push(escapeExpression(((stack1 = helpers['t'] || (depth0 && depth0['t'])),stack1 ? stack1.call(depth0, "application.navbar.graph", options) : helperMissing.call(depth0, "t", "application.navbar.graph", options))));
  }
...
function program11(depth0,data) {
  ...
  stack2 = ((stack1 = helpers['link-to'] || (depth0 && depth0['link-to'])),stack1 ? stack1.call(depth0, "graph", options) : helperMissing.call(depth0, "link-to", "graph", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("</li>\r\n                    <li>");
  hashContexts = {'class': depth0};
  hashTypes = {'class': "STRING"};
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "loadStrategies", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push(" style=\"cursor:pointer; background-color: #C4CEDD;\" class=\"badge\">");
  hashTypes = {};
  hashContexts = {};
...
function program3(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers.unbound.call(depth0, "administration.selectionCount", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("</span>\r\n                    ");
  return buffer;
  }
...
function program1(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers.unbound.call(depth0, "selectionCount", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("</span>\r\n                    </a>\r\n                </h4>\r\n            </div>\r\n            <div id=\"");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers.unbound.call(depth0, "administration.id", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
...
function program2(depth0,data) {
  ...
  data.buffer.push(escapeExpression(((stack1 = helpers.render || (depth0 && depth0.render)),stack1 ? stack1.call(depth0, "administration/strategy", "focusarea", options) : helperMissing.call(depth0, "render", "administration/strategy", "focusarea", options))));
  data.buffer.push("\r\n                    ");
  return buffer;
  }
  ...
  data.buffer.push(" class=\"strategies-administrations-tab tab-pane active\">\r\n    <div>\r\n        <div ");
  hashContexts = {'style': depth0};
  hashTypes = {'style': "ID"};
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {hash:{
  ...
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers.each.call(depth0, "theme", "in", "themes", {hash:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0,depth0,depth0],types:["ID","ID","ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\r\n</div>\r\n");
  return buffer;
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<div class=\"strategies-administrations-tab-pane tab-pane\" ");
  hashContexts = {'class': depth0};
  hashTypes = {'class': "ID"};
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {hash:{
